class Car:
    ...
    def stop(self):
        return f'\nThe {self.name} is stopped.'

    def turn(self, direction):
        return f'\nThe {self.name} is turned {direction}'
